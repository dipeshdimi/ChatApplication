...
export const AuthContextProvider = ({ children }) => {
    ...
    useEffect(() => {
        // onAuthStateChanged gives us user, i.e., the current user (the one that's logged in as of now). If the user returned within the handler is null we assume the user is currently signed-out, otherwise they are signed-in.
